...
void skor()
{
 gotoxy(30,1); cout << "SCORE :                                    ";
 gotoxy(59,1); cout << "PANJANG :           ";
}
//Untuk menulis skor terbaru dan panjang dari snake
void tulis_skor()
{
 gotoxy(39,1); cout << (nEkor - 5) * 10;
 gotoxy(70,1); cout << nEkor;
}
...
int main() //fungsi Utama
{
 ...
 gotoxy(3,1);    cout<< "NAMA PEMAIN : "<<nama<<endl;
 gotoxy(4,23);   cout<< "CLICK AREA GAME TO (PAUSE)"<<endl;
 while(!(isDestroy())) //selama snake belum rusak atau kalah
  {
   ...
   Sleep(60 - (nEkor / 10)); //delay yang semakin cepat dengan penambahan ekor
  }
